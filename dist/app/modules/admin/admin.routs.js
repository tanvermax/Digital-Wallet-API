...
router.get("/alluser", (0, cheakAuth_1.cheakAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.USER, user_interface_1.Role.AGENT), admin_controller_1.adminController.getAllUser);
// router.get("/userblock", cheakAuth(Role.ADMIN), adminController.getblock);
router.get("/allagent", (0, cheakAuth_1.cheakAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.USER, user_interface_1.Role.AGENT), admin_controller_1.adminController.getAllAgent);
